...
class Controller:
    ...
    def __init__ (self):
        ...
        Creates an instance of an object of the class Controller to be used 
    ...
    def set_point(self,new_setpoint):
        ...
        @param new_setpoint - Converted reference position
        '''
    ...
    def control_gain(self,new_Kp):
        ...
        @param new_Kp -  Converted proportional gain  
        '''
        K_p = float(new_Kp)
        return K_p
