...
#  Brief doc for EncoderDriver2.py
#
#  Detailed doc for EncoderDriver2.py 
#
...
class Encoder(): 
    ...
    def __init__(self,input_pin1,input_pin2,input_timer):
        ...
        @param input_pin1 pin that connects first input from the encoder to the microcontroller.
        
        @param input_pin2 pin that connects second input from the encoder to the microcontroller.
        
        @param input_timer sets up timer for timer channels
        '''
        ##Timer sets up the proper time channel based on the user input for the 
        #encoder reading
        ...
        print ('Creating a encoder driver') #prints specified message to command line
    ...
    def zero(self):
        '''
        Set the encoder counter to zero. Reinitializes shared variables
