...
PA0 = pyb.Pin (pyb.Pin.board.PA0, pyb.Pin.OUT_PP) #defines encoder pin
PC6 = pyb.Pin (pyb.Pin.board.PC6, pyb.Pin.OUT_PP) #defines pin IN1A
PC7 = pyb.Pin (pyb.Pin.board.PB5, pyb.Pin.OUT_PP) #defines pin IN1A
...
motor2 = MotorDriver(PA0,PC6,PC7,tim5)
enc1 = Encoder(PB4,PB5,tim3)   #creates object of class Encoder
enc2 = Encoder(PC6,PC7,tim5)
...
def task2_motorcontroller ():
    ...
    while True:
        ...
        level = control.closed_loop(y,10000,.02)
        motor1.set_duty_cycle(level) 
        motor2.set_duty_cycle(level) 
        yield (0)
